...
- The [Android Badge](/workflows/android-specific-workflow-steps/android-badge) step now supports adaptive and WebP launcher icons in addition to legacy PNG icons. <BuildIntegrationsBadge/> <CloudBadge/>
...
- The [Android Badge](/workflows/android-specific-workflow-steps/android-badge) step now supports adaptive and WebP launcher icons in addition to legacy PNG icons. <BuildIntegrationsBadge/> <CloudBadge/> <SelfHostedBadge/>
